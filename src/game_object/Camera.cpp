...
Camera::Camera(Window* aWindow, float initial_pos[3]):m_window(aWindow){ 
    ...
    this->m_projection = new Projection(glm::radians(45.0f),(float)this->m_window->GetWidth()/this->m_window->GetHeight());
    UpdateView();
...
const glm::mat4 Camera::GetProjection(){
    ...
    if(this->width > (this->m_window->GetWidth() + 40) || this->height > (this->m_window->GetHeight() + 40) ||
        ...
        this->m_projection->MakePerspective(glm::radians(45.0f),(float)this->m_window->GetWidth()/this->m_window->GetHeight());
