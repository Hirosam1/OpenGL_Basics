...
#LDLIBS_WIN = -static-libgcc -static-libstdc++  -Wl,-Bstatic,--whole-archive -lwinpthread -Wl,--no-whole-archive  -lpthread -pthread -Wl,-Bdynamic -lglfw3 -lglu32 -lgdi32
LDLIBS_WIN = -static-libgcc -static-libstdc++  -Wl,-Bstatic -Wl,-Bstatic,--whole-archive -lwinpthread -Wl,--no-whole-archive -Wl,-Bdynamic -lglfw3 -lglu32 -lgdi32
